...
def app():
    st.set_page_config(page_title="Don't Reinvent The Wheel", page_icon="🔘")
    main_markdown_path = os.path.join("assets", "markdown")
    markdown = read_markdown(os.path.join(main_markdown_path, "05_🔘_Don't_Reinvent_The_Wheel.md"))
