...
def app():
    ...
    st.markdown("")
    st.markdown("")
    st.markdown("Brought to you by **[Engineer Connect](https://www.linkedin.com/company/engineerconnect/) & [PT. Jokeen Solusi Teknologi (Jokeen.id)](https://www.linkedin.com/company/jokeen-id/)**")
